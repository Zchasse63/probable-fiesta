          ...
          return (
            ...
            >
              ...
              <div className="mb-4 p-3 bg-muted rounded">
                <div className="text-sm text-muted-foreground/80">Customers in Zone</div>
                <div className="text-2xl font-bold text-foreground">{customerCount}</div>
              </div>

              {/* States */}
              <div className="mb-4">
                <div className="text-sm font-medium text-foreground/80 mb-2">States</div>
                <div className="flex flex-wrap gap-1">
                  {zone.states?.map((state: string) => (
                    <span
                      key={state}
                      className="px-2 py-1 text-xs font-medium bg-accent text-foreground/80 rounded"
                    >
                      {state}
                    </span>
                  ))}
              ...
              {isEditing && (
                <div className="flex gap-2 pt-4 border-t">
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-primary text-primary-foreground rounded hover:bg-primary disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={updateZone.isPending}
                    className="flex-1 px-4 py-2 bg-muted text-foreground/80 rounded hover:bg-accent disabled:opacity-50"
                  >
                    Cancel
                  </button>
                </div>
