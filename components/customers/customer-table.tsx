      ...
      <table className="min-w-full divide-y divide-border">
        <thead className="bg-muted">
          <tr>
            ...
            <th
              className="px-6 py-3 text-left text-xs font-medium text-muted-foreground/80 uppercase tracking-wider cursor-pointer hover:bg-accent"
              ...
              <td className="px-6 py-4 whitespace-nowrap text-muted-foreground/80">
                <div className="text-sm">
                  ...
                  {customer.contact_email && (
                    <div className="text-muted-foreground/60">{customer.contact_email}</div>
                  )}
                </div>
              </td>
